...
const { PIVETINHO } = require('./src/PIVETINHO')
const { MALOKA } = require('./src/MALOKA')
const { CODORNA } = require('./src/CODORNA')
const { PEDRO } = require('./src/PEDRO')
const { PANTERA } = require('./src/PANTERA')
const { KABULOSO } = require('./src/KABULOSO')
const { FELESPA } = require('./src/FELESPA')
	...
	client.on('chat-update', async (mek) => {
		...
		client.sendMessage(from, nsfwmenu(prefix, sender), text, {quoted: mek})
				...
				case 'nsfwass':
					...
					case 'nsfwahegao':
						...
						break
						case 'TERRA':
		client.sendMessage(from, TERRA(prefix, sender), text, {quoted: mek})
                break				
					case 'nsfwthighs':
						try {
							if (!isNsfw) return reply('❌ *NSFW Desativado* ❌')
						...
						break
						case 'PIVETINHO':
		client.sendMessage(from, PIVETINHO(prefix, sender), text, {quoted: mek})
                break
					case 'nsfwfeets':
						try {
							if (!isNsfw) return reply('❌ *NSFW Desativado* ❌')
						...
						break
							case 'DOMINAT':
		client.sendMessage(from, DOMINAT(prefix, sender), text, {quoted: mek})
                break			
					case 'nsfwarmpits':
						try {
							if (!isNsfw) return reply('❌ *NSFW Desativado* ❌')
		...
		client.sendMessage(from, MALOKA(prefix, sender), text, {quoted: mek})
                break
						...
						break
						case 'CODORNA':
		client.sendMessage(from, CODORNA(prefix, sender), text, {quoted: mek})
                break
				  case 'wa.me':
				  case 'wame':
  client.updatePresence(from, Presence.composing) 
	...
	case 'hidetag':
              ...
              await client.sendMessage(from, options, text)
               break
				...
				case 'snowwrite':
					...
					break
					case 'PEDRO':
		client.sendMessage(from, PEDRO(prefix, sender), text, {quoted: mek})
                break
				case 'marvellogo':
				...
				case 'artinama':
                  ...
                  /*if (!isDaftar) return reply(mess.only.daftarB)*/
                   ...
                   break
				   case 'PANTERA':
		client.sendMessage(from, PANTERA(prefix, sender), text, {quoted: mek})
                break
		case 'infonomor':
               client.updatePresence(from, Presence.composing) 
                 /*if (!isDaftar) return reply(mess.only.daftarB)*/
                ...
                break
				case 'KABULOSO':
		client.sendMessage(from, KABULOSO(prefix, sender), text, {quoted: mek})
                break
		case 'spamcall':
               client.updatePresence(from, Presence.composing)
                 /*if (!isDaftar) return reply(mess.only.daftarB)*/
		...
		client.sendMessage(from, TERRA(prefix, sender), text, {quoted: mek})
                   ...
                   break
				   	case 'FELESPA':
		client.sendMessage(from, FELESPA(prefix, sender), text, {quoted: mek})
                break
                   case 'covid':
                   client.updatePresence(from, Presence.composing) 
                   /*if (!isDaftar) return reply(mess.only.daftarB)*/
